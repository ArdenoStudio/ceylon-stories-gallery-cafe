...
export default function WhatsAppFloat() {
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-[90] flex items-center gap-3 bg-mahogany text-cream-page px-4 py-3 shadow-ink group"
    ...
    >
      ...
      <svg
        ...
        viewBox="0 0 24 24"
        fill="currentColor"
        className="w-4 h-4 shrink-0 text-gold-leaf"
      >
