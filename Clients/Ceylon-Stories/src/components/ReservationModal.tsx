...
const partySizes = ['1 person', '2 people', '3 people', '4 people', '5 people', '6 people', '7 people', '8+ people'];
const timeSlots = ['08:30 AM', '10:00 AM', '12:30 PM', '03:00 PM', '06:30 PM', '08:30 PM'];

const fieldClassName =
  'w-full rounded-[18px] border border-mahogany/10 bg-white/70 px-4 py-3 font-body text-sm text-mahogany outline-none transition-colors placeholder:text-mahogany/35 focus:border-mahogany/25 focus:bg-white';
...
export default function ReservationModal({
  ...
  return createPortal(
    <AnimatePresence>
      {open ? (
        <motion.div
          className="fixed inset-0 z-[90] flex items-end justify-center bg-mahogany/55 p-3 backdrop-blur-[6px] sm:items-center sm:p-6"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          onClick={handleClose}
        >
          <motion.div
            className="relative max-h-[92vh] w-full max-w-6xl overflow-hidden rounded-[30px] border border-mahogany/10 bg-cream-page text-mahogany shadow-[0_24px_100px_rgba(42,24,16,0.28)]"
          ...
          >
            ...
            <div className="relative grid max-h-[92vh] overflow-y-auto lg:grid-cols-[1fr_1.2fr]">
              <div className="relative overflow-hidden border-b border-mahogany/10 px-6 pb-8 pt-16 sm:px-8 sm:pb-10 sm:pt-20 lg:border-b-0 lg:border-r lg:px-10 lg:pb-12 lg:pt-16">
                <div className="absolute -right-16 bottom-0 text-[140px] leading-none text-mahogany/5 select-none">
                  RSVP
                </div>
                ...
                <div className="mt-10 space-y-4">
                  <div className="rounded-[22px] border border-mahogany/10 bg-white/55 p-4">
                    <div className="flex items-start gap-3">
                      <CalendarDays className="mt-0.5 size-4 text-clay-warm" strokeWidth={1.7} />
                      <div>
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="rounded-[22px] border border-mahogany/10 bg-white/55 p-4">
                      <div className="flex items-center gap-3">
                        <Users className="size-4 text-clay-warm" strokeWidth={1.7} />
                        <div>
                          <p className="font-editorial text-[9px] uppercase tracking-[0.28em] text-mahogany/45">
                            Party Size
                          </p>
                    ...
                    <div className="rounded-[22px] border border-mahogany/10 bg-white/55 p-4">
                      <div className="flex items-center gap-3">
                        <Clock3 className="size-4 text-clay-warm" strokeWidth={1.7} />
                        <div>
                          <p className="font-editorial text-[9px] uppercase tracking-[0.28em] text-mahogany/45">
                            Preferred Time
                          </p>
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                  <div>
                    ...
                    <p
                      ...
                      role="region"
                    >
                      {dateError ? 'Please choose a reservation date' : 'Preferred reservation day'}
                    </p>
                  </div>
                  ...
                  <div className="rounded-[22px] border border-mahogany/10 bg-white/55 p-4">
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                      <div className="space-y-2">
                        ...
                        <div className="space-y-2 text-sm text-mahogany/70">
                          <p className="flex items-center gap-2">
                            <Mail className="size-4 text-clay-warm" strokeWidth={1.7} />
                            Sends the request to `hello@ceylonstories.lk`
                          </p>
                          <p className="flex items-center gap-2">
                            <Phone className="size-4 text-clay-warm" strokeWidth={1.7} />
                      ...
                      <div className="flex gap-3">
                        <button
                          type="button"
                          onClick={handleClose}
                          className="rounded-full border border-mahogany/10 px-5 py-3 font-editorial text-[10px] uppercase tracking-[0.26em] text-mahogany transition-colors hover:border-mahogany/20 hover:bg-mahogany/5"
                        >
                          Cancel
                        </button>
                        <button
                          type="submit"
                          className="rounded-full bg-mahogany px-6 py-3 font-editorial text-[10px] uppercase tracking-[0.28em] text-cream-page shadow-[0_14px_36px_rgba(42,24,16,0.22)] transition-transform duration-300 hover:-translate-y-0.5"
                        >
                          Send Request
                        </button>
                      </div>
