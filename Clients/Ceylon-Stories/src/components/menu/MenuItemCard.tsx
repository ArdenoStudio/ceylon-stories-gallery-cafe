    ...
    return (
      ...
      >
        ...
        <div className="relative overflow-hidden rounded-t-lg">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-mahogany/50 to-transparent" />
          ...
          >
            ...
            >
              <div className={cn('w-2.5 h-2.5 rounded-full', isVegetarian ? 'bg-sage-deep' : 'bg-clay-deep')} />
            </div>
          </motion.div>

          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 w-full flex justify-center">
            <button
              onClick={(e) => { e.stopPropagation(); onAdd(e.currentTarget.getBoundingClientRect()) }}
        ...
        <div className="flex flex-col flex-grow p-4">
          ...
          <div className="flex items-start justify-between gap-2">
            <h3 className="font-display text-[18px] leading-[1.1] text-mahogany flex-1">
              {name}
            </h3>
          ...
          <div className="flex items-center justify-between mt-auto pt-3">
            <div className="flex items-center gap-1.5 font-editorial text-[9px] tracking-[0.1em] uppercase text-mahogany/45">
