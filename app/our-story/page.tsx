...
export default function OurStoryPage() {
  ...
  return (
    <>
      ...
      {/* Founders */}
      <section ref={heroRef} className="relative w-full bg-cream-page py-[clamp(80px,12vh,160px)] px-6 overflow-hidden">
            ...
            >
              ...
              <div className="pl-6 border-l border-mahogany/20 space-y-6">
                <p className="font-body text-mahogany/70 text-sm leading-[1.8]">
                  Ceylon Stories was born from a shared conviction — that Colombo deserved a space where art, culture, and the ritual of a good cup of tea could coexist without noise. Shazi and Rumaiz opened the doors on Marine Drive in January 2026.
                </p>
                <p className="font-body text-mahogany/70 text-sm leading-[1.8]">
      ...
      <section className="relative w-full bg-cream-page py-[clamp(80px,12vh,160px)] px-6">
        <div className="max-w-5xl mx-auto text-center flex flex-col items-center gap-10">
          ...
          >
            ...
            <blockquote className="font-display font-light italic text-mahogany text-[clamp(28px,4vw,56px)] leading-[1.2] tracking-[-0.01em] max-w-3xl mx-auto">
              &ldquo;Slowness is not a deficiency. It is the entire point.&rdquo;
            </blockquote>
            <p className="font-body text-mahogany/60 text-sm leading-[1.8] max-w-[48ch] mx-auto mt-8">
