              ...
              <motion.div className="mt-10 flex flex-wrap items-center gap-4" variants={itemVariants}>
                ...
                {secondaryCallToAction ? (
                  <a
                    ...
                    className="group inline-flex items-center gap-3 border border-white/40 bg-white/15 px-7 py-3.5 font-editorial text-[11px] uppercase tracking-[0.24em] text-mahogany backdrop-blur-md backdrop-saturate-150 shadow-[inset_0_1px_0_rgba(255,255,255,0.5),inset_0_-1px_0_rgba(15,8,5,0.04),0_10px_28px_rgba(15,8,5,0.14)] transition-all duration-500 hover:border-white/60 hover:bg-white/25 hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.65),inset_0_-1px_0_rgba(15,8,5,0.05),0_16px_36px_rgba(15,8,5,0.2)]"
                  >
