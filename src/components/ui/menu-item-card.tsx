      ...
      >
        ...
        <div className="relative overflow-hidden rounded-t-lg">
          <img
            ...
            alt={name}
            loading="lazy"
            className="object-cover w-full h-56 transition-transform duration-500 ease-out group-hover:scale-105 photo-heritage"
          />
        ...
        <div className="flex flex-col flex-grow p-4">
          ...
          <div className="flex items-baseline gap-2">
            <span className="font-display text-lg font-light text-mahogany">LKR {price.toLocaleString()}</span>
            {savings > 0 && (
              <>
                <span className="font-body text-xs line-through text-mahogany/40">LKR {originalPrice.toLocaleString()}</span>
