        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-end gap-16 lg:gap-20 xl:gap-28">
          ...
          <div className="flex-1 flex flex-col min-w-0 pb-4">
            ...
            <div className="flex items-center gap-5 mb-10">
              <span className="font-editorial text-[10px] tracking-[0.2em] text-cream-page/35 tabular-nums">
                {String(currentIndex).padStart(2, '0')} / {String(TOTAL_DRINKS).padStart(2, '0')}
              </span>
              <div className="w-px h-4 bg-cream-page/20" />
              <button
                onClick={handleNext}
                className="flex h-9 cursor-pointer select-none items-center gap-2 rounded-full border border-cream-page/20 bg-cream-page/8 px-5 font-editorial text-[10px] tracking-[0.2em] uppercase text-cream-page/65 transition-all duration-200 hover:bg-cream-page/15 hover:text-cream-page active:scale-[0.97]"
              >
                Next Item
